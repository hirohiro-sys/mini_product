...
READMEはQiitaの以下の記事を参考に作成しました。まだ学習段階の小規模なアプリのため、ER図やインフラ構成図などは作ってません。また初めはデプロイをして誰かに使ってもらうことを考えていたのですが、セキュリティ関連の知識など不足しているものが多すぎると感じたので、renderで一度デプロイしてから現在は公開していません。どんなアプリかのイメージを持ってもらうためにトップページの画像だけ貼っておきます。
...
トップページ画像↓ 画面に収まらず二つに分けました(GIFとかの方が良かったか)
...
・基本情報技術者(基本的なコンピュータサイエンス習得のため)等

*それぞれ書籍や入門教材を使用して学習



## <初めてアプリを作ってみての感想 & 今後の展望>
開発に必要な要素を一つ一つ学習して一つのアプリという形でアウトプットしていく過程を通してソフトウェア開発の面白さを実感できた。また開発を通して自分に足りない部分がこんなにもあるんだと知った(笑)。今後は

・react等のフロントエンドも学んでAPI開発

・思いついた機能随時実装

・デプロイや人に使ってもらえるアプリにするためのセキュリティやサーバ等の学習
