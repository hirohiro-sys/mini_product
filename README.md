...
READMEはQiitaの以下の記事を参考に作成しました。まだ学習段階の小規模なアプリのため、ER図やインフラ構成図などは作ってません。また初めはデプロイをして誰かに使ってもらうことを考えていたのですが、セキュリティ関連の知識など不足しているものが多すぎると感じたのでデプロイ等も行なっていません。どんなアプリかのイメージを持ってもらうためにトップページの画像だけ貼っておきます。
